const COMPANY_MARKET_DATA = {
  ...
  'Vestas': { primaryMetricLabel:'Fwd P/E', primaryMetricValue:'15,6x', secondaryMetricLabel:'EV/Sales', secondaryMetricValue:'8,7x', metricWhy:'Hardware-marginer er volatile, så sales- og forward earnings-lens bruges ofte sammen.', peerComp:{ vs:'Siemens Gamesa', status:'praemie', multiple:'ikke børsnoteret' } },
  ...
  'Genmab': { primaryMetricLabel:'Fwd P/E', primaryMetricValue:'15,2x', secondaryMetricLabel:'P/B', secondaryMetricValue:'2,71x', metricWhy:'Royalty- og pipelinecases bliver ofte værdisat via earnings plus balance-sheet quality.', peerComp:{ vs:'argenx', status:'par', multiple:'pipeline-peer' } },
  ...
  'Zealand Pharma': { primaryMetricLabel:'EV/Sales', primaryMetricValue:'54,2x', secondaryMetricLabel:'Fwd P/E', secondaryMetricValue:'ikke profitabel', metricWhy:'Fedmemarkedspipeline gør det til handlet på potentiale snarere end nuværende bundlinje.', peerComp:{ vs:'Viking Therapeutics', status:'rabat', multiple:'71,0x' } },
